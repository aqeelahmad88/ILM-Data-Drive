...
<div class="col-xs-12">
  <form role="form" id="<?php echo $variable; ?>" name="<?php echo $variable; ?>" method="post" action="<?php echo site_url($variable.'/add_new_success'); ?>" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-2">
        <select class="chosen-select" id="<?php echo $element; ?>" name="<?php echo $element; ?>" data-placeholder="Choose a <?php echo string_filter("Vendor"); ?>...">
          ...
          <option value="<?php echo $data->id; ?>"><?php echo $data->vendor; ?></option>
          <?php } ?>
          <?php } ?>
        </select>
      </div>
    ...
    <?php }else{ ?>
    <input type="hidden" value="<?php echo $user->vendorid; ?>" name="vendorid" />
    <?php } ?>
    ...
    <div class="form-group">
      ...
      <label for="<?php echo $element; ?>" class="col-sm-2 control-label no-padding-right"> <?php echo string_filter($element); ?>: </label>
      <div class="col-sm-9">
        <input type="text" class="col-xs-10 col-sm-3" id="<?php echo $element; ?>" name="<?php echo $element; ?>" value="<?php echo $this->input->post($element); ?>">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <label for="<?php echo $element; ?>" class="col-sm-2 control-label no-padding-right"> <?php echo string_filter($element); ?>: </label>
      <div class="col-sm-9">
        <input type="password" class="col-xs-10 col-sm-3" id="<?php echo $element; ?>" name="<?php echo $element; ?>" value="">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <label>
          <input type="checkbox" class="ace ace-switch ace-switch-4 btn-flat" id="<?php echo $element; ?>" name="<?php echo $element; ?>" checked="checked">
