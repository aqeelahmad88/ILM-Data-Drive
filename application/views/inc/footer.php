...
<div class="footer">
  <div class="footer-inner">
    <div class="footer-content"> <span class="bigger-120"> <span class="blue bolder"><?php echo site_title; ?></span> Application &copy; 2013-<?php echo date('Y'); ?> </span> &nbsp; &nbsp; <!--<span class="action-buttons"> <a href="#"> <i class="ace-icon fa fa-twitter-square light-blue bigger-150"></i> </a> <a href="#"> <i class="ace-icon fa fa-facebook-square text-primary bigger-150"></i> </a> <a href="#"> <i class="ace-icon fa fa-rss-square orange bigger-150"></i> </a> </span>--> </div>
  </div>
</div>
...
<script type="text/javascript">
			jQuery(function($) {
				...
				*/
				$(".chzn-select").chosen();
				$("#add_new_semester").on(ace.click_event, function() {
					
					bootbox.prompt("Please type semester name", function(result) {
						if (result === null || result == "") {
							
						} else {
							if($.isNumeric(result)==false){
								alert("Please enter only numeric data. Like 1, 2, 3....");
								return false;
							}
							$.post("<?php echo site_url("semesters_subjects/add_semester"); ?>", {semester:result}).done(function(result){
								if(result==1){
									window.location = "<?php echo site_url("semesters_subjects"); ?>";
								}else{
									alert(result);	
								}
							});
			...
			function add_new_subject(semester_id){
				bootbox.prompt("Please type subject name", function(result) {

					if (result === null || result == "") {
					} else {
                            
						$.post("<?php echo site_url("semesters_subjects/add_subject"); ?>", {semester_id:semester_id, subjects: result}).done(function(re){
							if(re==1){
								window.location = "<?php echo site_url("semesters_subjects"); ?>";
							}else{
								alert(re);	
